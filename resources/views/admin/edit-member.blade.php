      ...
      <div class="content-wrapper">
       ...
       <div class="row">
        ...
        <div class="col-md-3">
			...
			<li class="list-group-item"> {{trans('users.following')}} <strong class="pull-right color-strong">{{ App\Helper::formatNumber( $data->following()->count() ) }}</strong></li>
			<li class="list-group-item"> {{trans('users.followers')}} <strong class="pull-right color-strong">{{ App\Helper::formatNumber( $data->followers()->count() ) }}</strong></li>
			
			<li class="list-group-item"> {{trans('misc.collections')}} <strong class="pull-right color-strong">{{ App\Helper::formatNumber( $data->collections()->count() ) }}</strong></li>
