        	...
        	<div class="box box-danger">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/profiles-social') }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">人人网</label>
                      <div class="col-sm-10">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{ $settings->linkedin }}" name="linkedin" class="form-control" placeholder="{{ trans('admin.url_social') }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
